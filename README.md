...
1. **CLPIPPy** - MINI PROJECT #04: CI Pipeline for a Python App
2. **Autoscaler** - MINI PROJECT #08: Kubernetes Horizontal Pod Autoscaler
3. **To-Do API** - MINI PROJECT #03: Dockerized To-Do API
4. **Health Monitor** - MINI PROJECT #01: Sysadmin Automation Kit
5. **K8sheal** - MINI PROJECT #07: Kubernetes Self-Healing App Demo
6. **LintGate** - MINI PROJECT #05: Infrastructure-as-Code CI/CD Lab
